...
void printhelp()
{
    ...
    cout << "-O: the level of optimization, supported levels: -O0, -O1, -O2, -O3, -Oz, -Os. If you ignore this argument, it will not optimize" << endl;
    cout << "For a instance: " << endl;
    cout << "If you want to compile source file test.c, get the output file out.o, get the llvm ir code file ir.ll, get the visualization file visual.html and optimize program in level O2" << endl;
    cout << "You should use command line: MySysY -i test.c -o out.o -l -v -O2" << endl;
    return;
}
...
int main(int argc, const char *argv[]) {
    ...
    //             auto it = InputFile.end();
    //             advance(it, -2);
    //             VisualizationFile = InputFile.substr(0, distance(InputFile.begin(), it));
    //             VisualizationFile += ".html";
    //         }
    //         else {
    //             VisualizationFile = "-";
    //         }
    ...
    //     else if(s[0] == '-' && s[1] == 'O')
    //     {
    //         if(s == "-O0" || s == "-O1"|| s == "-O2" || s == "-O3"|| s == "-Oz" || s == "-Os")
    //         {
    //             OptimizeLevel = s;
    //         }
    //         else
